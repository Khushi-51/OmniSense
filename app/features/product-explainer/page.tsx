    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">🧠 Smart Product Explainer</h1>
        ...
        <div className="text-center mb-8 flex flex-wrap justify-center gap-4">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-all duration-200"
          >
            <Music size={18} />
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-pink-100 text-pink-700 rounded-lg hover:bg-pink-200 transition-all duration-200"
          >
            <Heart size={18} />
